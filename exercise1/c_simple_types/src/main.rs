...
fn main() {
    ...
    //
    let coords_a: [f32; 2] = [coords.0, coords.1];  // create an array literal out of parts of `coord` here
    print_array(coords_a);  // and pass it in here (this line doesn't need to change)
