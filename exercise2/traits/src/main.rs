#[derive(Debug,Clone, Copy, PartialEq, From<Party>)]
pub enum Cake {
    Chocolate,
    MapleBacon,
    Spice,
...
impl From<Cake> for String {
    fn from(cake: Cake) -> Self{
        /*
        match cake {
            cake::Chocolate => "The name's Chocolate. Dark...Chocolate.".to_string(),
            cake::MapleBacon => "Dreams do come true!".to_string(),
            cake::Spice => "Great, let's spice it up!".to_string(),
        }*/
        "d".to_string()
    }
}
